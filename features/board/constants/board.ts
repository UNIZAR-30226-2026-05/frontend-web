/**
 * Calibrated coordinates for the board game.
 * indices 0-71 represent the squares on the board path.
 * 
 * Each point { x, y } is expressed as a percentage of the total width/height
 * of the board background image (tablero_def.png).
 */
